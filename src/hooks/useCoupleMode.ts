  ...
  const sendCoins = useCallback(async (amountInput: number, messageInput: string) => {
    ...
    try {
      ...
      await runTransaction(firestore, async (transaction) => {
        ...
        transaction.set(receiverRef, { coins: receiverCoins + amount, updatedAt: serverTimestamp(), lastCoinTransferRoomId: roomId, lastCoinTransferActionId: actionId }, { merge: true });
