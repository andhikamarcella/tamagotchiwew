...
export type ThemeName = 'Green Retro' | 'Pink Candy' | 'Blue Ocean' | 'Yellow Pixel' | 'Dark Arcade' | 'Cream Cozy' | 'Purple Night' | 'Mint Pixel' | 'Sunset Pet' | 'Forest Buddy' | 'Snow Day' | 'Retro Gray' | 'Neon Lime';
...
export type PetPersonality = 'Playful' | 'Sleepy' | 'Foodie' | 'Shy' | 'Brave' | 'Curious' | 'Gentle' | 'Naughty' | 'Loyal' | 'Moody';
